...
<div class="flex flex-col md:flex-row font-mono gap-x-8 mt-20 px-16">
  ...
  <div id="about" class="basis-3/4">
    ...
    <div
      class="card preset-filled-surface-100-900 border-[1px] border-surface-200-800 w-full p-4 space-y-4 text-sm align-middle place-content-center font-thin mt-4"
    >
      <p>
